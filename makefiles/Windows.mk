...
lint: ## check style with flake8
	flake8 system-intelligence tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source system-intelligence -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\system-intelligence.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs system-intelligence
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
